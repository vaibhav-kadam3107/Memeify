...
export default function Navbar() {
  ...
  const handleMobileMenuToggle = () => {
    setMobileMenuOpen(prev => {
      console.log("Mobile menu state:", !prev); // Log the new state
      return !prev;
    });
  };
      ...
      >
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end gap-4">
          ...
          <button
            ...
            className="text-sm font-semibold leading-6 text-gray-800 hover:text-indigo-600 transition-all "
          >
            New user? <span className="text-indigo-600 underline underline-offset-2">Sign up</span>
          </button>
        </div>
      </nav>
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                ...
                <div className="text-red-500">Debug: Navigation items rendered</div>
              </div>
              <div className="py-6">
                <button
                  onClick={handleLogin}
